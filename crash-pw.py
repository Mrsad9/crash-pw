...
def improve_dictionary(file_to_open):
    ...
    if leetmode == "y":
        for (
            ...
            unique_lista
        ):  # if you want to add more leet chars, you will need to add more lines in crash.cfg too...
    ...
    print_to_file(file_to_open + ".crash.txt", unique_list_finished)
...
# the main function
def main():
    """Command-line interface to the crash utility"""

    read_config(os.path.join(os.path.dirname(os.path.realpath(__file__)), "crash.cfg"))
