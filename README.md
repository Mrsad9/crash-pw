# CRASH - Common User Passwords Profiler
...
## Configuration
   ...
   CRASH has configuration file crash.cfg with instructions.

## Example (Fast forwarded)

![crash-example](screenshots/crash-example.gif)
